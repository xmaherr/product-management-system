...
<%--                    <form:form id="save" action="update-product" modelAttribute="product" method="post" enctype="multipart/form-data">--%>
<%--                    </form:form>--%>

<%--                    <form action="delete-image" method="post" class="mt-2">--%>
<%--                    </form>--%>
<%--                    <input type="hidden" name="id" value="${product.id}" />--%>
<%--                    <div class="mb-3">--%>
<%--                        <label for="name" class="form-label">Product Name</label>--%>
<%--                        <form:input id="name" path="name" cssClass="form-control" form="save"/>--%>
